    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        if timeSecond > 7200 {
            picker.dismiss(animated: true, completion: {
                let actionSheetController: UIAlertController = UIAlertController(title: "Thông báo".localizedString(), message: "Ảnh bạn chọn là ảnh đã chụp quá 2 tiếng trước".localizedString(), preferredStyle: .alert)
